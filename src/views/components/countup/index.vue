    ...
    <el-row :gutter="20">
      ...
      <el-col :span="6">
        <el-card shadow="never" >
          <p slot="title">小数位数</p>
          <div class="group">
            <nx-count-up :end="100" :decimals="2"/>
          </div>
        </el-card>
      </el-col>
      <el-col :span="6">
        <el-card shadow="never" >
          <p slot="title">动画时长</p>
          <div class="group">
            <nx-count-up :end="100" :duration="6"/>
          </div>
        </el-card>
      </el-col>
      <el-col :span="6">
        <el-card shadow="never">
          <p slot="title">回调函数</p>
          <div class="group">
            <nx-count-up :end="100" :callback="() => {className = 'end'}" :class="className"/>
          </div>
        </el-card>
      </el-col>
      <el-col :span="6">
        <el-card shadow="never" class="d2-mb-0">
          ...
          <div class="group">
            <nx-count-up :end="end" :callback="update"/>
          </div>
        </el-card>
      </el-col>
    </el-row>
