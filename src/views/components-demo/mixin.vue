...
<script>
import PanThumb from '@/components/nx-pant-humb'
import MdInput from '@/components/nx-mdinput'
import Mallki from '@/components/nx-text-hover-effect'
import DropdownMenu from '@/components/nx-share'
