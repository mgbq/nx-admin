<template>
  <div class="components-container">
    ...
    <div class="editor-container">
      <nx-markdown-editor id="contentEditor" ref="contentEditor" v-model="content" :height="300" :zIndex="20"></nx-markdown-editor>
    </div>
...
<script>
import nxMarkdownEditor from '@/components/nx-markdown-editor'
